...
#set_property PACKAGE_PIN W3 [get_ports {data_o[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o[6]}]
#set_property PACKAGE_PIN U3 [get_ports {data_o[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o[7]}]
#set_property PACKAGE_PIN P3 [get_ports {data_o[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o[0]}]
#set_property PACKAGE_PIN N3 [get_ports {data_o[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o[1]}]
#set_property PACKAGE_PIN P1 [get_ports {data_o2[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o2[2]}]
#set_property PACKAGE_PIN L1 [get_ports {data_o2[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_o2[3]}]
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports cntr_clear]						
#	set_property IOSTANDARD LVCMOS33 [get_ports cntr_clear]
