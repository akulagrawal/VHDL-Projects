...
set rc [catch {
  ...
  add_files -quiet F:/2/assgn7/assgn7.runs/synth_1/top_level.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_level_timing_summary_routed.rpt -rpx top_level_timing_summary_routed.rpx -warn_on_violation "
