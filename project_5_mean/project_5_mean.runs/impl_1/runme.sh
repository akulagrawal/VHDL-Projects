...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_mean/project_5_mean.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mean_8num_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mean_8num_8bit.tcl -notrace
