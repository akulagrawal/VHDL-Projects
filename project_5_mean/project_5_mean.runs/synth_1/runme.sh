...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_mean/project_5_mean.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mean_8num_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mean_8num_8bit.tcl
