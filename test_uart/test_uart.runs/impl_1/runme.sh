...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/test_uart/test_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_rx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_rx.tcl -notrace
