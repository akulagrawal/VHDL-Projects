...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/test_uart/test_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_rx.tcl
