...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_rw/project_5_rw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_rw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_rw.tcl
