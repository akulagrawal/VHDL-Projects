...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_rw/project_5_rw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_rw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_rw.tcl -notrace
