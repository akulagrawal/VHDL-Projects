...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplier_8bit.tcl
