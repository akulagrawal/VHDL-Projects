...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplier_8bit.tcl -notrace
