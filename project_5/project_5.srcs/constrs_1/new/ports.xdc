...
#set_property PACKAGE_PIN R2 [get_ports d2]
...
#set_property PACKAGE_PIN V13 [get_ports res1]
#	set_property IOSTANDARD LVCMOS33 [get_ports res1]
#set_property PACKAGE_PIN V3 [get_ports res2]
#	set_property IOSTANDARD LVCMOS33 [get_ports res2]
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {state_display[0]}]
set_property PACKAGE_PIN P1 [get_ports {state_display[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {state_display[0]}]
set_property PACKAGE_PIN L1 [get_ports {state_display[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {state_display[1]}]
...
set_property PACKAGE_PIN U18 [get_ports compute]
	set_property IOSTANDARD LVCMOS33 [get_ports compute]
