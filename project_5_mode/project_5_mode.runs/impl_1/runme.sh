...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_mode/project_5_mode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mode_8num_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mode_8num_8bit.tcl -notrace
