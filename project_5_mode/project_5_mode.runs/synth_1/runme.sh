...
HD_PWD='C:/Users/Sanjai Kumar Agrawal/Desktop/project_5_mode/project_5_mode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mode_8num_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mode_8num_8bit.tcl
